...
- **🧠 Choice-Based Storytelling:** Make decisions that directly impact the storyline and ending.
- **❤️ Health System:** Track player health with a visual progress bar.
- **🎒 Inventory System:** Collect and manage items throughout the game.
- **🎨 Modern UI Design:** - Dark theme
  - Styled buttons and panels
  - Dynamic layout resizing
- **🖼️ Dynamic Backgrounds:** Chapter-based background images that change as the story progresses.
- **🔊 Sound Effects & Music:** Background music changes per chapter for immersion.
- **📳 Screen Shake Effect:** Visual feedback during intense moments (e.g., damage events).
- **💾 Save & Load System:** Save your progress and continue anytime.
- **🔁 Restart Functionality:** Restart the game instantly from the main menu.
...
1. Controls story progression
2. Handles player choices
3. Updates UI through callbacks:
...
Bash
git clone [https://github.com/your-username/zombie-apocalypse-telltale.git](https://github.com/your-username/zombie-apocalypse-telltale.git)
Open Zombie apocolypse telltale.sln in Visual Studio.

Press F5 to build and run.

🎯 Gameplay
Launch the game and click START GAME.
...
🖼️ Assets
Make sure these folders exist in your project's build directory (bin/Debug):

images/ → Backgrounds (chapter1.jpg, za.jpg, etc.)
